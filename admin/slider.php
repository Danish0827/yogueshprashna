        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.php" class="nav-link">Home / Slider</a>
                </li>
                        ...
                        <form action="slider-db.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="addSlider" class="btn btn-primary">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal fade" id="deleteData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="slider-db.php" method="POST">
                            <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="deleteSlider" class="btn btn-primary">Yes,Delete!</button>
                            </div>
                    </div>
                    </form>
                </div>
                ...
                ' . $_SESSION['status'] . '</h4></div>';
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="#" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#AddSlider">Add Image</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="datatable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?= $i; ?></td>
                                                        <td><img src="upload/slider/<?= $row['image']; ?>" alt="Loading" width="100"></td>
                                                        <td>
                                                            <a href="slider-edit.php?slider_id=<?php echo ($row['id']); ?>" class="btn btn-info btn-sm">Edit</a>
