                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Update Portfolio
                                    </h3>
                                    <a href="portfolio.php" class="btn btn-primary btn-sm btn-danger float-right">Back</a>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            if (isset($_GET['portfolio_id'])) {
                                                ...
                                                $query = "SELECT * FROM image_gallery WHERE id='$portfolio_id'";
                                            ...
                                            ?>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 mb-3">
                                                                        <button type="submit" name="updatePortfolio" class="btn btn-info">Update Portfolio</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td class="text-center">No Portfolio Found </td>
                                                    </tr><?php
                                                        }
                                                    }
                                                            ?>
